...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::HiRACalibratedData*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("HiRACalibratedData", ::HiRACalibratedData::Class_Version(), "HiRACalibratedRootEvent.h", 8,
                  typeid(::HiRACalibratedData), ::ROOT::Internal::DefineBehavior(ptr, ptr),
   ...
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const ::HiRACalibratedData*)0x0); R__UseDummy(_R__UNIQUE_DICT_(Init));
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::HiRACalibratedBuffer*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("HiRACalibratedBuffer", ::HiRACalibratedBuffer::Class_Version(), "HiRACalibratedRootEvent.h", 48,
                  typeid(::HiRACalibratedBuffer), ::ROOT::Internal::DefineBehavior(ptr, ptr),
   ...
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const ::HiRACalibratedBuffer*)0x0); R__UseDummy(_R__UNIQUE_DICT_(Init));
} // end of namespace ROOT
...
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::HiRACalibratedData*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::HiRACalibratedBuffer*)0x0)->GetClass(); }
   return fgIsA;
}
...
#line 1 "HiRACalibratedDict dictionary forward declarations' payload"
...
#line 1 "HiRACalibratedDict dictionary payload"
...
nullptr
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("HiRACalibratedDict",
        ...
        TriggerDictionaryInitialization_HiRACalibratedDict_Impl, {}, classesHeaders, /*hasCxxModule*/false);
      isInitialized = true;
    }
  }
