...
OBJS += HiRACsICalibration.$(ObjSuf) HiRASiCalibration.$(ObjSuf) HTHiRARootEvent.$(ObjSuf) HiRADetectorStatus.$(ObjSuf) HiRAGeometry.$(ObjSuf)
OBJS += HiRAPixelization.$(ObjSuf) HiRAIdentification.$(ObjSuf) HiRAEdFIdentificationParameters.$(ObjSuf) elist.$(ObjSuf) HiRAPixel.$(ObjSuf)
...
OBJS += HiRAEnergyLoss.$(ObjSuf) EnergyLossModule.$(ObjSuf) nuclear_masses.$(ObjSuf) KinematicsModule.$(ObjSuf)
...
ROOTHTTSE15190_HDRS  := HTTSe15190RootEvent.h HTSisTimestampe15190LinkDef.h
ROOTHTTSE15190_DICT  := HTTSe15190Dict.$(SrcSuf)
ROOTHTTSE15190_DICTH := $(ROOTHTTSE15190_DICT:.$(SrcSuf)=.h)
ROOTHTTSE15190_DICTO := $(addprefix $(ObjDir), $(ROOTHTTSE15190_DICT:.$(SrcSuf)=.$(ObjSuf)))
ROOTHTTSE15190_PCM   := HTTSe15190Dict$(PcmSuf)
...
$(PROG): $(OBJS) $(ROOTHTNW_DICTO) $(ROOTHTVW_DICTO) $(ROOTHTFA_DICTO) $(ROOTNWCALIBRATED_DICTO) $(ROOTHTMB_DICTO) $(ROOTMBCALIBRATED_DICTO) $(ROOTHTHIRA_DICTO) $(ROOTHIRACALIBRATED_DICTO) $(ROOTHTTSE15190_DICTO)
...
$(ROOTHTTSE15190_DICT):
	@echo "Generating dictionary $@..."
	$(ROOTCLINGORCINT) -f $@ -p $(INCLUDES) $(ROOTHTTSE15190_HDRS)

install : $(E15190SHARED) $(PROG)
	$(MAKE) -C HTRunInfo install

$(E15190SHARED): $(OBJS) $(ROOTHTNW_DICTO) $(ROOTHTVW_DICTO) $(ROOTHTFA_DICTO) $(ROOTNWCALIBRATED_DICTO) $(ROOTHTMB_DICTO) $(ROOTMBCALIBRATED_DICTO) $(ROOTHTHIRA_DICTO) $(ROOTHIRACALIBRATED_DICTO) $(ROOTHTTSE15190_DICT)
	$(CXX) $(CXXFLAGS) -shared -o $(LibDir)${@} $^ $(SYSLIB) $(CFLAGS) $(RLIBS)
	cp $(ROOTHTNW_PCM) $(ROOTHTFA_PCM) $(ROOTHTVW_PCM) $(ROOTHTMB_PCM) $(ROOTNWCALIBRATED_PCM) $(ROOTMBCALIBRATED_PCM) $(ROOTHTHIRA_PCM) $(ROOTHIRACALIBRATED_PCM) $(ROOTHTTSE15190_PCM) $(LibDir)
...
distclean:
	...
	@$(RM) -f $(OBJS) $(ROOTHTNW_DICT) $(ROOTHTNW_PCM) $(ROOTHTNW_DICTO) $(ROOTHTNW_DICTH) $(ROOTHTVW_DICT) $(ROOTHTVW_PCM) $(ROOTHTVW_DICTO) $(ROOTHTVW_DICTH)\
		...
		$(ROOTHIRACALIBRATED_DICT) $(ROOTHIRACALIBRATED_PCM) $(ROOTHIRACALIBRATED_DICTO) $(ROOTHIRACALIBRATED_DICTH) $(ROOTHTTSE15190_DICT) $(ROOTHTTSE15190_PCM) $(ROOTHTTSE15190_DICTH) $(ROOTHTTSE15190_DICTO) \
   	$(LibDir)$(ROOTHTNW_PCM) $(LibDir)$(ROOTHTVW_PCM) $(LibDir)$(ROOTHTMB_PCM) $(LibDir)$(ROOTNWCALIBRATED_PCM) $(LibDir)$(ROOTMBCALIBRATED_PCM) $(LibDir)$(ROOTHTHIRA_PCM) \
	 	$(LibDir)$(ROOTHIRACALIBRATED_PCM) $(LibDir)$(ROOTHTTSE15190_PCM) $(LibDir)$(ROOTHTFA_PCM) $(LibDir)$(E15190SHARED)
...
clean:
	...
	@$(RM) -f $(OBJS) $(ROOTHTNW_DICT) $(ROOTHTNW_PCM) $(ROOTHTNW_DICTO) $(ROOTHTNW_DICTH) $(ROOTHTVW_DICT) $(ROOTHTVW_PCM) $(ROOTHTVW_DICTO) $(ROOTHTVW_DICTH)\
	 ...
	 $(ROOTHTTSE15190_DICT) $(ROOTHTTSE15190_PCM) $(ROOTHTTSE15190_DICTO) $(ROOTHTTSE15190_DICTH) \
